...
int main()
{
	...
	fd2 = open("datosLDAP.txt",O_WRONLY);
	if(fd2 == -1){
		...
		while(1){	
			...
			/*  TELEFONO  */
				...
				/*  AREA DE CONOCIMIENTO  */
					...
					memset(salida, '\0', sizeof(salida));
					strcpy(salida,"Area de Conocimiento:");
					while(1){
						read(fd1,&c,1);
						if(c==':')
							break;
